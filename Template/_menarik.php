...
<section id="new-phones" class="container mb-5">
    <div class="container card shadow py-3">
        <h4 class="font-rubik bg-primary w-25 two-values py-2 px-5 text-white"
            style="border-radius: 2px 40px; text-indent: 4px;">Menarik</h4>
                ...
                <div class="item py-2 bg-white m-3 img-fluid">
                    <div class="product font-rale card p-5 card-item">
                        <a href="detail_produk.php?item=<?= urlencode($product['nama_produk']) ?>">
                            <img class="img-list-cover d-block mx-auto"
                                src="assets/img/products/<?= htmlspecialchars($product['gambar_produk']); ?>"
                                alt="<?= htmlspecialchars($product['gambar_produk']); ?>"  style="max-width: 150px; max-height: 150px;" >
                        </a>
                        ...
                        <div class="text-center">
                            ...
                            <form method="post" class="py-3">
                                <div class="d-flex justify-content-center">
                                    ...
                                    <?php else: ?>
                                        <button type="submit" name="menarik_submit" class="btn btn-primary font-size-12 mr-2">Add to Cart</button>
                                    <?php endif; ?>
                                </div>
                            </form>
                        </div>
